CREATE TABLE [Person].[StateProvince] (
	...
	-- NOTE: This came from the AW Db. Will not be needed in the bounded domain of Job Search Contacts
...
GO
--NOTE: This came from the AW Db. Will not be needed in the bbounded domain of Job Search Contacts
