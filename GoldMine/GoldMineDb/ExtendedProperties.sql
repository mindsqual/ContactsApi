EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'GoldMine OLTP Database';
...
--GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Primary filegroup for the GoldMine database.', @level0type = N'FILEGROUP', @level0name = N'PRIMARY';
