...
IF NOT EXISTS (SELECT * FROM [Person].[AddressType] WHERE Name='Branch Office')
	INSERT INTO [Person].[AddressType] ([AddressTypeID], [Name], [rowguid], [ModifiedDate]) VALUES (4, N'Branch Office', N'8eeec28c-07a2-4fb9-ad0a-42d4a0bbc575', GETDATE())
IF NOT EXISTS(SELECT * FROM [Person].[AddressType] WHERE Name='Primary')
	INSERT INTO [Person].[AddressType] ([AddressTypeID], [Name], [rowguid], [ModifiedDate]) VALUES (5, N'Primary', N'24cb3088-4345-47c4-86c5-17b535133d1e', GETDATE())
IF NOT EXISTS(SELECT * FROM [Person].[AddressType] WHERE Name='Shipping')
	INSERT INTO [Person].[AddressType] ([AddressTypeID], [Name], [rowguid], [ModifiedDate]) VALUES (6, N'Shipping', N'b29da3f8-19a3-47da-9daa-15c84f4a83a5', GETDATE())
